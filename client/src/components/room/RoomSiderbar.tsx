  ...
  return (
    <>
      {chat.isChatOpen && (
        <div
          ref={menuRef.chat}
          className="absolute right-0 z-50 flex h-full w-[24rem] shrink-0 flex-col border-l border-[#EDF0F6] bg-gray-100 shadow-md dark:border-[#1F2335] dark:bg-darkBlue-600 md:static"
        >
